...
class GitRepo {
    ...
    pull(...args) {
        ...
        this._git(this._getOptions(), 'pull', command, this._logError(this._logExecOutput(next)));
    }
    ...
    push(...args) {
        ...
        this._git(this._getOptions(), 'push', command, this._logError(this._logExecOutput(next)));
    }
}
